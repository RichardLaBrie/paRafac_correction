...
plot.integrate.RAMAN.go <- function(EEM, maxf, graph=T){
  ...
  # Substract baseline
  Df = data.frame(x = c(EEM$wlem[em370:em380], EEM$wlem[em414:em428]), y = c(EEM$EEM.list$eem[ex350,em370:em380], EEM$EEM.list$eem[ex350,em414:em428]))
  mod = lm(y~x, data=Df)
  offset = predict(mod, newdata = data.frame(x = EEM$wlem[em370:em428]))
  raman = EEM$EEM.list$eem[ex350,em370:em428] - offset
  ...
  if(graph)
  {
    plot(EEM$wlem[em370:em428], EEM$EEM.list$eem[ex350,em370:em428],
         type="l", lwd=3,
